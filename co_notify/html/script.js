...
if(event.data.action == "bildirim") {
  ...
  if (str == "yellow") { app = "img/yellow.png"; title = "Mercado Libre"; }
  if (str == "mesaj") { app = "img/sms.png"; title = "Mensaje"; }
...
function degistir(){
  ...
  document.getElementById("anim_text").innerHTML = sol+" Colgar - Contestar "+sag;
}
